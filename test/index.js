...
module.exports = {
  ...
  'BSON.prototype': {
    ...
    '#engine': function() {
      ...
      assert.equal ( serializer.engine, require('buffalo') );
    },
    ...
    '#serialize': {
      ...
      '(object)': function() {
        ...
        assert.deepEqual ( serializer.serialize(object), require('buffalo').serialize({_id: 1, a: "foo", b: "bar"}) );
      }
    },
    ...
    '#deserialize': {
      ...
      '(data)': function() {
        var data = require('buffalo').serialize({_id: 1, a: "foo", b: "bar"});
